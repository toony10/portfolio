...
const About = ({ isDarkMode }: AboutProps) => {
    return (
        <div id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
            ...
            <div className='flex flex-col lg:flex-row w-full items-center gap-20 my-20 mx-auto'>
                ...
                <div className='flex-1'>
                    ...
                    <ul className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
                        { infoList.map(
                            (item, index) => (
                                <li key={ index } className='border-[0.5px] border-gray-400 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:hover:bg-black/30'>
